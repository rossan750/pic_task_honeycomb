...
import { jitterx, jitter50, formatDollars, deepCopy, randomTrue } from '../lib/utils';
import _ from 'lodash';

describe('generic utility functions', function () {
  it('should jitter an integer', function () {
    assert.equal(jitterx(100, 0), 100, 'jittering by 0 returns base');
    assert.closeTo(jitterx(100, 10), 100, 10, 'jittering 100 by 10 is close to 100');
